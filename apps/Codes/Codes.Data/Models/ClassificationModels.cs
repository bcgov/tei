namespace TEI.Codes.Data.Models;
...
{
    public required List<CodeDescription> BgcCodeValues { get; init; }
    public required List<CodeDescription> ZoneCodeValues { get; init; }
    ...
    public required List<ResultPreview> ResultPreviews { get; init; }
    public required FullBgcEcoCode? UniqueResult { get; init; }
}

public record ResultPreview
{
    public required string BgcLabel { get; init; }
    public required string? BgcDetail { get; init; }
    public required string? ZoneDetail { get; init; }
    public required string EcosystemCode { get; init; }
    public required string SiteSeriesName { get; init; }
...
public record FullBgcEcoCode
{
    ...
    public CodeDescription? BgcCode { get; set; }
    public CodeDescription? ZoneCode { get; set; }
    public string SubzoneCode { get; set; } = string.Empty;
    public string VariantCode { get; set; } = string.Empty;
    public string PhaseCode { get; set; } = string.Empty;
    public string EcosystemCode { get; set; } = string.Empty;
    public CodeDescription? MapCode { get; set; }
    ...
    public CodeDescription? EcosystemType { get; set; }
    public CodeDescription? EcosystemSubtype { get; set; }
    public CodeDescription? KindType { get; set; }
