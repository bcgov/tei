namespace TEI.Database.Model.Context;
...
public partial class TeiDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Bedrocktype>(
            entity =>
            {
        ...
        modelBuilder.Entity<Bgccode>(
            entity =>
            {
                ...
                entity.HasOne(d => d.VariantCodeNavigation)
                    .WithMany(p => p.Bgccodes)
        ...
        modelBuilder.Entity<Datagroup>(
            entity =>
            {
                ...
                entity.HasMany(d => d.ProjectBaps)
        ...
        modelBuilder.Entity<Ecocomponent>(
            entity =>
            {
                ...
                entity.HasOne(d => d.BgcEcocode)
                    .WithMany(p => p.Ecocomponents)
                ...
                entity.HasOne(d => d.SiteModifierCode1Navigation)
                    .WithMany(p => p.EcocomponentSiteModifierCode1Navigations)
                    .HasForeignKey(d => d.SiteModifierCode1)
                    .HasConstraintName("sitemodifiercode_ecocomponent_1");

                entity.HasOne(d => d.SiteModifierCode2Navigation)
                    .WithMany(p => p.EcocomponentSiteModifierCode2Navigations)
                    .HasForeignKey(d => d.SiteModifierCode2)
                    .HasConstraintName("sitemodifiercode_ecocomponent_2");
            });

        modelBuilder.Entity<Ecoobject>(
            entity =>
            {
                ...
                entity.HasOne(d => d.BgcCodeNavigation)
                    .WithMany(p => p.Ecoobjects)
                    .HasForeignKey(d => d.BgcCode)
                    .HasConstraintName("bgccode_ecoobject");
            });

        modelBuilder.Entity<Ecosystemsubtype>(
            entity =>
            {
        ...
        modelBuilder.Entity<Ecosystemtype>(
            entity =>
            {
        ...
        modelBuilder.Entity<Geometry>(
            entity =>
            {
                ...
                entity.HasMany(d => d.MethodologyCodes)
                    .WithMany(p => p.Geometries)
                    .UsingEntity<Dictionary<string, object>>(
                        "GeometryMethodology",
                        r => r.HasOne<Methodologycode>()
                            .WithMany()
        ...
        modelBuilder.Entity<GeometryGeomorphicprocess>(
            entity =>
            {
                ...
                entity.HasOne(d => d.GeoMorphicProcess)
                    .WithMany(p => p.GeometryGeomorphicprocesses)
        ...
        modelBuilder.Entity<Geometrytype>(
            entity =>
            {
        ...
        modelBuilder.Entity<Geomorphicprocess>(
            entity =>
            {
        ...
        modelBuilder.Entity<Geopoint>(
            entity =>
            {
                ...
                entity.HasOne(d => d.PointTypeNavigation)
                    .WithMany(p => p.Geopoints)
                    .HasForeignKey(d => d.PointType)
                    .HasConstraintName("pointtype_geopoint");
            });

        modelBuilder.Entity<Geopolygon>(
            entity =>
            {
                ...
                entity.HasOne(d => d.Geometry)
                    .WithMany(p => p.Geopolygons)
                    .HasForeignKey(d => d.GeometryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("geometry_geopolygon");

                entity.HasMany(d => d.Points)
        ...
        modelBuilder.Entity<GroupcodeClasscode>(
            entity =>
            {
                ...
                entity.HasOne(d => d.ClassCodeNavigation)
                    .WithMany(p => p.GroupcodeClasscodes)
        ...
        modelBuilder.Entity<Layer>(
            entity =>
            {
                ...
                entity.HasOne(d => d.Expression1)
                    .WithMany(p => p.LayerExpression1s)
                    .HasForeignKey(d => d.Expression1Id)
                    .HasConstraintName("expression_layer_1");

                entity.HasOne(d => d.Expression2)
                    .WithMany(p => p.LayerExpression2s)
                    .HasForeignKey(d => d.Expression2Id)
                    .HasConstraintName("expression_layer_2");

                entity.HasOne(d => d.Expression3)
                    .WithMany(p => p.LayerExpression3s)
                    .HasForeignKey(d => d.Expression3Id)
                    .HasConstraintName("expression_layer_3");

                entity.HasOne(d => d.LayerTypeNavigation)
                    .WithMany(p => p.Layers)
        ...
        modelBuilder.Entity<Legacyproject>(
            entity =>
            {
        ...
        modelBuilder.Entity<Methodologycode>(
            entity =>
            {
        ...
        modelBuilder.Entity<PointVeglayer>(
            entity =>
            {
        ...
        modelBuilder.Entity<Project>(
            entity =>
            {
                ...
                entity.HasMany(d => d.EcoObjects)
                    .WithMany(p => p.ProjectBaps)
                    .UsingEntity<Dictionary<string, object>>(
                        "ProjectEcoobject",
                        r => r.HasOne<Ecoobject>()
                            .WithMany()
        ...
        modelBuilder.Entity<ProjectParty>(
            entity =>
            {
        ...
        modelBuilder.Entity<Projectrelation>(
            entity =>
            {
                ...
                entity.HasOne(d => d.ProjectBapid1Navigation)
                    .WithMany(p => p.ProjectrelationProjectBapid1Navigations)
                    .HasForeignKey(d => d.ProjectBapid1)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("project_projectrelation1");

                entity.HasOne(d => d.ProjectBapid2Navigation)
                    .WithMany(p => p.ProjectrelationProjectBapid2Navigations)
                    .HasForeignKey(d => d.ProjectBapid2)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("project_projectrelation2");

                entity.HasOne(d => d.RelationDescription)
        ...
        modelBuilder.Entity<Relationdescription>(
            entity =>
            {
        ...
        modelBuilder.Entity<Sitecomponentcode>(
            entity =>
            {
                ...
                entity.HasOne(d => d.AssociationCodeNavigation)
        ...
        modelBuilder.Entity<Siteseriescode>(
            entity =>
            {
        ...
        modelBuilder.Entity<Ssphasecode>(
            entity =>
            {
        ...
        modelBuilder.Entity<Subclasscode>(
            entity =>
            {
        ...
        modelBuilder.Entity<Tercomponent>(
            entity =>
            {
                ...
                entity.HasOne(d => d.BedrockTypeNavigation)
                    .WithMany(p => p.Tercomponents)
        ...
        modelBuilder.Entity<Variationcode>(
            entity =>
            {
        ...
        modelBuilder.Entity<Veglayercode>(
            entity =>
            {
        ...
        modelBuilder.Entity<Vegspeciescode>(
            entity =>
            {
                ...
                entity.HasMany(d => d.VegLayerCodes)
                    .WithMany(p => p.VegSpeciesCodes)
                    .UsingEntity<Dictionary<string, object>>(
                        "VegspeciesVeglayer",
                        r => r.HasOne<Veglayercode>()
                            .WithMany()
                            .HasForeignKey("VegLayerCode")
                            .OnDelete(DeleteBehavior.ClientSetNull)
                            .HasConstraintName("veglayercode_vegspecies_veglayer"),
                        l => l.HasOne<Vegspeciescode>()
                            .WithMany()
                            .HasForeignKey("VegSpeciesCode")
                            .OnDelete(DeleteBehavior.ClientSetNull)
